CREATE TABLE [dbo].[OrderDetails] (
    ...
    [CreatedDate] DATETIME   NOT NULL CONSTRAINT [DF_OrderDetails_CreatedDate] DEFAULT GETDATE(),
    [UpdatedDate] DATETIME   NOT NULL CONSTRAINT [DF_OrderDetails_UpdatedDate] DEFAULT GETDATE(),
